...
class ClDOSPAIVals(ClDOSPAIStorage):
    ...
    def add(self, mem_with_score: Tuple[Tuple[int, int], Any]):
        ...
        assert self._d_lkp.get(key, None) is None, 'Error, ClDOSPAIVals may not include repeated key'
...
class ClDOSPAIMem(ClDOSPAIStorage):
    ...
    def __init__(self, utc_start, filename_body) -> None:
        ...
        Returns:
            None
        """
        super().__init__(utc_start, DOSPAICacheContent, filename_body)
